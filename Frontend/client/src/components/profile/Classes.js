...
import logo from './img.gif'; // with import
import './style.css';
...
class Classes extends Component {
    ...
    onPress (data) {
        ...
        axios({
            method: 'post',
            url: 'http://localhost:3001/delete_sub',
            data: {
              data,
              token: token
            }
...
<div class="col-3 mt-3 mb-3" id="main"style={{paddingLeft:'30px',paddingBottom: '100px',paddingRight:'300px'}}>
<Draggable>
